 ...
 */
 ...
 /*
 MAC address is 48 bits and IPv4 address is 32 bits
 */
...
module toplevel(
	...
	wire        ip_send_ready, arp_send_ready, req_en, r_mac_cache_en;//, axi_ip_ready, axi_arp_ready;
	wire [31:0] arp_send_ip_addr, r_mac_cache_ip_addr;//, axi_ip_data, axi_arp_data;
//	wire [47:0] axi_ip_mac, axi_arp_mac;
